...
if __name__ == '__main__':
	...
	test_derivate_p1(x3_0, x3_1, 0.1, 0.74, 0.22, "x^3")

	test_derivate_p2(x3_0, x3_2, 0.1, 0.97, 0.33, "x^3")

	table = {i: x3_0(i) for i in arange(0, 10, 0.05)}
	y1, y2, y3 = Splining(x3_0, 0.1, 0.74, 0.22, 2)
	fig = plt.figure(figsize=[8,6])
	plt.plot([(0.74*x + 0.22) for x in range(10)], [x3_2(x, 0.74, 0.22) for x in range(10)], label="Точная")
	...
	# 	test_derivate_p0(x4_0, 0.1, 1, 0.28, "x^4")
	# for h=0.1:   36.827566836562255
	# for h=0.05:  14.68398421148413
	# for h=0.025: 2.5207741506319508

	# test_derivate_p1(x4_0, x4_1, 0.1, 0.1, 0.91, "x^4")
	...
	# test_derivate_p1(sinx_0, sinx_1, 0.1, 0.73, 0.22, "sinx")
	# test_derivate_p2(sinx_0, sinx_2, 0.1, 1, 0.21, "sinx")